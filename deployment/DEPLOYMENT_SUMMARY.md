...
- **Staging**: https://tms-chat-staging.hotelsogo-ai.com (47.80.66.95)
- **Production**: https://tms-chat.hotelsogo-ai.com (47.80.71.165)
...
Nginx (Reverse Proxy)
    ...
    └─→ /*      → Next.js Frontend (localhost:3000)
         ↓
    Services
    ├─→ PostgreSQL RDS (pgm-5tsq1t17984pyydh0o...)
    ├─→ Tair Redis (r-5tsm9aoc5soeozbq3v...)
    └─→ OSS (tms-oss-goli)
```
...
```
Type: A
Name: tms-chat-staging.hotelsogo-ai.com
Value: 47.80.66.95

Type: A
Name: tms-chat.hotelsogo-ai.com
Value: 47.80.71.165
```
...
Database: pgm-5tsq1t17984pyydh0o.pgsql.ap-southeast-6.rds.aliyuncs.com
Redis: r-5tsm9aoc5soeozbq3v.redis.ap-southeast-6.rds.aliyuncs.com
```
...
1. **Deploy Staging First** (test everything)
   - Server: 47.80.66.95
   - Domain: tms-chat-staging.hotelsogo-ai.com
...
3. **Deploy Production** (when staging works)
   - Server: 47.80.71.165
   - Domain: tms-chat.hotelsogo-ai.com
