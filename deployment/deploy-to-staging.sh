...
# Obtain certificate
certbot --nginx -d tms-chat-staging.hotelsogo-ai.com --non-interactive --agree-tos --email admin@hotelsogo-ai.com --redirect
...
curl -I https://tms-chat-staging.hotelsogo-ai.com 2>&1 | head -1
curl https://tms-chat-staging.hotelsogo-ai.com/health 2>&1
curl https://tms-chat-staging.hotelsogo-ai.com/api/v1/health 2>&1
...
echo -e "  ${GREEN}https://tms-chat-staging.hotelsogo-ai.com${NC}"
echo ""
echo "API Documentation:"
echo -e "  ${GREEN}https://tms-chat-staging.hotelsogo-ai.com/docs${NC}"
echo ""
echo "View logs:"
