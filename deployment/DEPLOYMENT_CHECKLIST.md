...
- [ ] Database password: `Syxgim-zynciw-qibxe7`
- [ ] Redis password: `gosgoj-9gygwo-Dusbob`
...
### 2. DNS Configuration ✓/✗
- [ ] A record: `tms-chat-staging.hotelsogo-ai.com` → `47.80.66.95`
- [ ] A record: `tms-chat.hotelsogo-ai.com` → `47.80.71.165`
- [ ] TTL set low (300s) for easy updates
- [ ] Wait 5-60 minutes for propagation
- [ ] Test: `nslookup tms-chat-staging.hotelsogo-ai.com`
...
Open in browser: `https://tms-chat-staging.hotelsogo-ai.com`
...
# - Use tms-chat.hotelsogo-ai.com for SSL
