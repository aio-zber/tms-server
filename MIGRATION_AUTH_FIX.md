...
TMS_API_KEY="goh9oNDRy0Hs6O6CjnpI6ZiUMOT3xXnlhm+oFQvMamw="
TMS_API_TIMEOUT="30"
JWT_SECRET="krYggXL+KsnsKl0hvE7NqBcTlX2Pq6BwhPsnUUAI4FE="  # ❌ Didn't match GCGC!
...
USER_MANAGEMENT_API_KEY="goh9oNDRy0Hs6O6CjnpI6ZiUMOT3xXnlhm+oFQvMamw="  # ✅ API key for GCGC
USER_MANAGEMENT_API_TIMEOUT="30"
JWT_SECRET="v1hM2qTu7ckPz8evUzN3EEn0tNUyndttn/sRvkeEl7k="  # ✅ Matches GCGC's NEXTAUTH_SECRET!
```
...
4. **Add new variables:**
   ...
   - Add `USER_MANAGEMENT_API_KEY` = `goh9oNDRy0Hs6O6CjnpI6ZiUMOT3xXnlhm+oFQvMamw=`
   - Add `USER_MANAGEMENT_API_TIMEOUT` = `30` (optional)
5. **Update JWT secret:**
   - Update `JWT_SECRET` = `v1hM2qTu7ckPz8evUzN3EEn0tNUyndttn/sRvkeEl7k=`
...
2. Or, restore old environment variables temporarily:
   ...
   TMS_API_KEY="goh9oNDRy0Hs6O6CjnpI6ZiUMOT3xXnlhm+oFQvMamw="
   JWT_SECRET="krYggXL+KsnsKl0hvE7NqBcTlX2Pq6BwhPsnUUAI4FE="
   ```
...
**Fix:** Ensure `JWT_SECRET=v1hM2qTu7ckPz8evUzN3EEn0tNUyndttn/sRvkeEl7k=`
