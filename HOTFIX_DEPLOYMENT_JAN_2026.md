...
ALLOWED_ORIGINS=https://tms-chat-staging.hotelsogo-ai.com,https://tms-chat.hotelsogo-ai.com
ALLOWED_HOSTS=tms-chat-staging.hotelsogo-ai.com,tms-chat.hotelsogo-ai.com
...
curl https://tms-chat-staging.hotelsogo-ai.com/api/v1/conversations/ \
...
| `ALLOWED_ORIGINS` | `https://tms-chat-staging.hotelsogo-ai.com,https://tms-chat.hotelsogo-ai.com` | `http://localhost:3000` |
| `ALLOWED_HOSTS` | `tms-chat-staging.hotelsogo-ai.com,tms-chat.hotelsogo-ai.com` | `localhost,127.0.0.1` |
