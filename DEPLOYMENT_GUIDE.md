...
**PostgreSQL RDS:**
- Endpoint: `pgm-5tsq1t17984pyydh0o.pgsql.ap-southeast-6.rds.aliyuncs.com:5432`
- Username: `postgres`
- Production DB: `tms_production_db`
- Staging DB: `tms_staging_db`

**Redis:**
- Endpoint: `r-5tsm9aoc5soeozbq3v.redis.ap-southeast-6.rds.aliyuncs.com:6379`
...
```env
# Database
DATABASE_URL=postgresql+asyncpg://postgres:Syxgim-zynciw-qibxe7@pgm-5tsq1t17984pyydh0o.pgsql.ap-southeast-6.rds.aliyuncs.com:5432/tms_production_db
DATABASE_URL_SYNC=postgresql://postgres:Syxgim-zynciw-qibxe7@pgm-5tsq1t17984pyydh0o.pgsql.ap-southeast-6.rds.aliyuncs.com:5432/tms_production_db

# Redis
REDIS_URL=redis://:gosgoj-9gygwo-Dusbob@r-5tsm9aoc5soeozbq3v.redis.ap-southeast-6.rds.aliyuncs.com:6379/0
...
DEBUG=false
ALLOWED_ORIGINS=https://tms-chat.hotelsogo-ai.com,https://www.tms-chat.hotelsogo-ai.com
```
...
```env
# API URLs
NEXT_PUBLIC_API_URL=https://tms-chat.hotelsogo-ai.com/api
NEXT_PUBLIC_WS_URL=wss://tms-chat.hotelsogo-ai.com/ws
...
NEXTAUTH_URL=https://tms-chat.hotelsogo-ai.com
...
sudo certbot --nginx -d tms-chat.hotelsogo-ai.com -d www.tms-chat.hotelsogo-ai.com

# Or for staging
sudo certbot --nginx -d tms-chat-staging.hotelsogo-ai.com
...
psql -h pgm-5tsq1t17984pyydh0o.pgsql.ap-southeast-6.rds.aliyuncs.com -U postgres -d tms_production_db
